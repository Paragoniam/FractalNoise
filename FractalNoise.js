...
class SimplexNoise {
    ...
    noise1D(x, Fre, Amp) {
      return this.noise2D(x*Fre,0)*Amp
    }
    ...
    noise4D(px, py, pz, pw, Fre, Amp) {
        ...
        return (27.0 * (n0 + n1 + n2 + n3 + n4))*Amp
    }
}
...
class FractalNoise {
  constructor ( Z, F, A, O, L, P ) {
    this.Seed = Z
    this.Frequency = F
    this.Amplitude = A
    this.Octaves = O
    this.Lacunarity = L//how much Fre grows per octave *
    this.Persistence = P//how much Amplitude shrinks per octave -
